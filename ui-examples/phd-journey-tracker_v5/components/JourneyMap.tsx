...
export const JourneyMap: React.FC<JourneyMapProps> = ({ playbook, currentActiveNodeId, locale, onOpenChat }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto pb-24 relative">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        className="fixed bottom-6 right-6 z-50 p-4 bg-primary-600 text-white rounded-full shadow-2xl shadow-primary-500/40 hover:bg-primary-500 transition-colors flex items-center justify-center"
      >
