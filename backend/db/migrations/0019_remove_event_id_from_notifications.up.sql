-- Remove event_id from admin_notifications trigger function
...
BEGIN
  ...
  -- Removed attachment_uploaded - state_changed is sufficient
  -- ELSIF NEW.event_type = 'file_attached' OR NEW.event_type = 'attachment_uploaded' THEN
