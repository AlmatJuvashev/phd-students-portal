        ...
        <div className="space-y-4">
          ...
          <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-6 text-center">
            <p className="text-destructive font-medium">
              {t("calendar.errors.fetch", { defaultValue: "Failed to load calendar events" })}
            </p>
            <p className="text-sm text-muted-foreground mt-2">
              {t("calendar.errors.check_connection", { defaultValue: "Please check your connection or try again later" })}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <span className="hidden sm:inline">{t("calendar.new_event", { defaultValue: "New Event" })}</span>
            <span className="sm:hidden">{t("calendar.new", { defaultValue: "New" })}</span>
          </Button>
        </div>
        ...
        <div className="bg-card border-2 border-border/50 rounded-2xl shadow-xl overflow-hidden">
          <div className="p-4 md:p-6" style={{ height: 'calc(100vh - 200px)', minHeight: '600px' }}>
            <Calendar
              localizer={localizer}
              ...
              messages={{
                ...
                yesterday: t("calendar.yesterday", { defaultValue: "Yesterday" }),
                tomorrow: t("calendar.tomorrow", { defaultValue: "Tomorrow" }),
                
                // Messages
                noEventsInRange: t("calendar.no_events", { defaultValue: "No events in this range" }),
                showMore: (total) => t("calendar.show_more", { defaultValue: `+${total} more`, count: total }),
              }}
