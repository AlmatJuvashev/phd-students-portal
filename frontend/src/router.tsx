...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'admin/users', element: <AdminUsers />, loader: () => guardRole(['admin','superadmin']), errorElement: <Forbidden /> },
      { path: 'checklist', element: <StudentChecklist />, loader: () => guardRole(['student','advisor','chair','admin','superadmin']), errorElement: <Forbidden /> },
      { path: 'advisor/inbox', element: <AdvisorInbox />, loader: () => guardRole(['advisor','chair','admin','superadmin']), errorElement: <Forbidden /> },
      {
        path: 'documents/:docId',
        loader: () => guardRole(['student','advisor','chair','admin','superadmin']),
